			...
			<div class="post">
				<div class="content">
					<a href="javascript:return false;"
						onclick="showMember(${message.toMemberId})"><span
						class="postId">${message.memberNick}님&nbsp;께서 보냈습니다.</span></a><span
						class="postDate">&nbsp;&nbsp;&nbsp;&nbsp;${message.regDate}</span>
					<p class="postText comment">
						${message.messageContent}
					</p>
					<hr>
					<button class="button" style="box-shadow: none; border: none;"
						onclick="showMember(${message.toMemberId})">
						<span class="icon solid far fa-paper-plane">&nbsp;&nbsp;답장하러 가기</span>
					</button>
					<button class="button" style="box-shadow: none; border: none;"
						onclick="complainMessage(${message.messageId}, ${sessionScope.member.memberId})">
						<span class="icon solid fas fa-exclamation-triangle"
							style="font-weight: normal;">&nbsp;신고하기</span>
					</button>
				</div>
			</div>
		</div>
