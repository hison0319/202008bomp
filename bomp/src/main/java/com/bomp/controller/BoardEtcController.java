...
@Controller
@RequestMapping("/board/etc")
public class BoardEtcController {
	...
	public String boardList(Model m, String arrMethod) {
		...
		return "/board/category/board_list_etc";			
	}
	
	private static final String CATEGORY = "기타";
	...
	public String boardList(@RequestParam Map<String, Object> parameters, HttpSession session) {
		...
		// 게시글 리스트
		System.out.println("페에지넘"+pageNum);
